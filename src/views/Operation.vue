<template>
  <div>
    ...
    <div class="department">
      ...
      <div class="divider">
        <img src="../assets/images/operation/Header.svg"/>
      </div>
      <div class="unique">
        ...
        <div class="unique-container">
          <div class="unique-container-left-side">
            ...
            <div class="unique-container-left-side-text">
              <h3 class="unique-container-left-side-title">Innovation, design, and technology</h3>
            </div>
          </div>
          <div class="unique-container-right-side">
            <p class="unique-container-right-side-text">
...
.operation-banner {
  background: url("../assets/images/operation/operation-bg.svg") no-repeat right top, linear-gradient(to bottom, #02185b, #00174e, #001542, #001135, #010c28);
  min-height: 702px;
  padding: 25px;
...
.mechanism {
  background: url("../assets/images/operation/shestiryonka.svg") no-repeat;
...
.brands {
  ...
  &-container {
    background: url("../assets/images/operation/shape.svg") no-repeat;
    background-size: cover;
    display: flex;
    align-items: center;
    justify-content: center;
